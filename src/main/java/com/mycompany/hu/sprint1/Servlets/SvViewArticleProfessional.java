 ...
 * @author Nicolas
 */
@WebServlet(name = "SvViewArticleProfessional", urlPatterns = {"/SvViewArticleProfessional"})
public class SvViewArticleProfessional extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        request.getSession().setAttribute("articleToDisplayProfessional", articleToDisplay);

        response.sendRedirect("ArticlesProfessional.jsp");
