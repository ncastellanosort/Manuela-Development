<%-- 
    ...
    Created on : Sep 29, 2024, 5:25:14 PM
    Author     : Nicolas
--%>
    ...
    <body>
        ...
        <section class="bg-white dark:bg-gray-900">
            <div class="py-8 px-4 mx-auto max-w-2xl lg:py-16">
                <h2 class="mb-4 text-xl font-bold text-gray-900 dark:text-white">Registrarse como Paciente</h2>
                <form action="SvRegisterPatient" method="POST">
