                    ...
                    <article class="bg-white shadow-lg rounded-lg overflow-hidden max-w-md">
                        ...
                        <div class="p-6">
                            ...
                            <footer class="flex flex-col items-start gap-4">
                                ...
                                <a href="SvViewArticleProfessional?url=<%= article.getUrl()%>" target="_blank" rel="noopener noreferrer" class="w-full inline-flex items-center justify-center px-4 py-2 border border-gray-300 shadow-sm text-sm font-medium rounded-md text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
                                    Read More
