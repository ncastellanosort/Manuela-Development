        ...
        <section class="flex-grow bg-gray-50 flex items-center justify-center">
            <div class="w-full bg-white rounded-lg shadow sm:max-w-md">
                <div class="p-6 space-y-4 sm:p-8">
                    ...
                    <form class="space-y-4" action="SvLoginPatient" method="POST">
                        <div>
                        ...
                        <p class="text-sm font-light text-gray-500">
                            No tienes una cuenta? <a href="PatientRegister.jsp" class="font-medium text-primary-600 hover:underline">Regístrate</a>
                        </p>
                    </form>
                </div>
            </div>
